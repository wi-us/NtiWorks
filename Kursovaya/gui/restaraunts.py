...
jungle.arrImagesLink = [
    methods.changeImageSize("NtiWorks/Kursovaya/resources/photos/jungle_1.png", IMAGE_WIDTH),
    methods.changeImageSize("NtiWorks/Kursovaya/resources/photos/jungle_2.png", IMAGE_WIDTH),
    methods.changeImageSize("NtiWorks/Kursovaya/resources/photos/jungle_3.png", IMAGE_WIDTH)
]
